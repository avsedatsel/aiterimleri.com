...
export const metadata: Metadata = {
  title: "Sanal Drone — Parsel Tanıtım Videosu",
  description:
    "TKGM kadastro verisiyle parsellerinizin uydu görüntülü 3D drone tanıtım videosunu tarayıcınızda oluşturun.",
  applicationName: "Sanal Drone",
...
// FOUC önleyici: sayfa boyanmadan önce tema sınıfını uygula (varsayılan koyu)
